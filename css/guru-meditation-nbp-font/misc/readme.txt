...
DESCRIPTION
===========
A pixel font inspired by bitmap fonts from old text editors. For those who don't know, "guru meditation" is the name of an error message from the Commodore Amiga operating system, circa 1988.

INSTALLING FONTS
================
For detailed instructions on how to install fonts in Windows, Mac, and Linux, visit....
http://sites.google.com/site/totalfontgeek/installing-new-fonts

LICENSE
=======
Guru Meditation is Creative Commons (by-sa) Attribution Share Alike. That means it's free to download and use. You can also upload it to another website but only as long as you give me credit for making it. You can even make changes to it as long as you give me credit for making the first version and license your new version as CC-BY-SA too.
